...
\section{Recovery Procedure}
	\begin{enumerate}
	  ...
	  \begin{figure}[h]
    	...
    	\caption{Removing the top cover}
	    \end{figure}
	    
	    \begin{figure}[h]
        \centering
    	\includegraphics[scale=0.08]{5.jpg}
    	\caption{Front PCB view}
	    \end{figure}
	  ...
	  \begin{figure}[h]
    	...
    	\caption{Device Manager Snippet}
	    \end{figure}
